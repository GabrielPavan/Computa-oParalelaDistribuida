...
class BackupServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteFile = channel.unary_unary(
                '/BackupService/DeleteFile',
                request_serializer=backup__pb2.FileRequest.SerializeToString,
                response_deserializer=backup__pb2.DeleteStatus.FromString,
                _registered_method=True)
...
def add_BackupServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteFile': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteFile,
                    request_deserializer=backup__pb2.FileRequest.FromString,
                    response_serializer=backup__pb2.DeleteStatus.SerializeToString,
            ),
    }
...
class BackupService(object):
    ...
    def UploadFile(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            backup__pb2.UploadStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DownloadFile(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/BackupService/DownloadFile',
            backup__pb2.FileRequest.SerializeToString,
            backup__pb2.FileChunk.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DeleteFile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/BackupService/DeleteFile',
            backup__pb2.FileRequest.SerializeToString,
            backup__pb2.DeleteStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
